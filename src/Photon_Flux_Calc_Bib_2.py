...
file_name = 'conv_1MHz_texp1.fits'
bias_name = 'bias.fits'
...
PFC = PhotonFluxCalc(img_name = file_dir + '\\' +  file_name, bias_name = file_dir + '\\' +  bias_name, xy_star = (539,527), sky_radius=100, ccd_serial=9916)
PFC.read_bias_img()
